(globalThis.TURBOPACK || (globalThis.TURBOPACK = [])).push(["chunks/node_modules_8c438872._.js",
...
function NextAuth(config) {
    if (typeof config === "function") {
        const httpHandler = async (req)=>{
            ...
            return Auth((0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2d$auth$2f$lib$2f$env$2e$js__$5b$middleware$2d$edge$5d$__$28$ecmascript$29$__["reqWithEnvURL"])(req), _config);
        };
        return {
            handlers: {
                GET: httpHandler,
    ...
    const httpHandler = (req)=>Auth((0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2d$auth$2f$lib$2f$env$2e$js__$5b$middleware$2d$edge$5d$__$28$ecmascript$29$__["reqWithEnvURL"])(req), config);
    return {
        handlers: {
            GET: httpHandler,
            POST: httpHandler
...
"[project]/node_modules/next-auth/providers/credentials.js [middleware-edge] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
//# sourceMappingURL=node_modules_8c438872._.js.map