    ...
    <div className="flex min-h-screen items-center justify-center bg-muted/30 px-4">
      ...
      >
        ...
        <div className="rounded-2xl border border-border bg-card p-8 shadow-elevated">
          {/* Google */}
          <Button variant="outline" className="w-full gap-3 h-11 mb-4" onClick={() => {}}>
          ...
          <div className="space-y-4">
            <div>
              ...
              <Input id="email" type="email" placeholder="farmer@thalia.com" value={email} onChange={(e) => setEmail(e.target.value)} className="mt-1.5" />
            </div>
            <div>
